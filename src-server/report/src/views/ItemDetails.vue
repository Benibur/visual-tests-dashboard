        ...
        <div class="items" v-for="item in items" v-bind:key="item.encoded">
            ...
            <div class="captures">
                ...
                <div v-if="actualDir" class="capture" v-on:click="open(item.encoded, actualDir)">
                    ...
                    :file="item.encoded" :setImageAsReference="setImageAsReference"></capture-image>
                </div>
...
export default {
  ...
  props: ['items', 'color', 'icon', 'openCapture', 'openComparison', 'diffDir', 'actualDir', 'expectedDir', 'shouldDisplaySetAsRef', 'setImageAsReference'],
  methods: {
